...
const transform7 = new Transform({
  ...
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(2.0821125507354736, 2.1784567832946777, 1.000595211982727)
})
...
const transform8 = new Transform({
  position: new Vector3(1, 6, 1.5),
  rotation: new Quaternion(-6.433131378134633e-15, -0.6949041485786438, 8.283903696337802e-8, -0.7191024422645569),
  scale: new Vector3(2.773987293243408, 2.84765625, 1.0005959272384644)
})
...
const transform9 = new Transform({
  position: new Vector3(1, 12.5, 13),
  rotation: new Quaternion(-6.433131378134633e-15, -0.6949041485786438, 8.283903696337802e-8, -0.7191024422645569),
  scale: new Vector3(2.773986339569092, 2.84765625, 1.000597357749939)
})
...
const transform11 = new Transform({
  position: new Vector3(15.5, 16, 3),
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(4.9238739013671875, 5.6953125, 1.0005931854248047)
})
...
script2.spawn(nftPictureFrame6, {"id":"19707794715962039650013670819326392846345927146224565303908839296232188805220","contract":"0x495f947276749ce646f68ac8c248420045cb7b5","style":"Blocky","color":"#000000","ui":true}, createChannel(channelId, nftPictureFrame6, channelBus))
